...
public class Main {
    public static void main(String[] args) {
        ...
        avl_bst3 = avl_bst3.remove(47);
        avl_bst3 = avl_bst3.remove(52);
        avl_bst3 = avl_bst3.remove(60);
        avl_bst3 = avl_bst3.remove(3);
        avl_bst3 = avl_bst3.remove(7);
        avl_bst3 = avl_bst3.remove(10);
        avl_bst3 = avl_bst3.remove(58);
    }
}
